...
const EmergenciaForm008 = React.forwardRef<HistoriaClinicaEmergenciaHandle, Props>(
  ...
  const [d, setD] = useState<DatosEmergencia>({
    ...
    tipo_doc: "CC/CI", estado_civil: "CAS",
    sexo: paciente?.sexo
      ? paciente.sexo.toUpperCase().startsWith("F") ? "F" : paciente.sexo.toUpperCase().startsWith("M") ? "M" : paciente.sexo
      : "", telefono_fijo: "N/R", telefono_celular: paciente?.telefono_celular ?? "",
    fecha_nacimiento: (paciente?.fecha_nacimiento ?? "").slice(0, 10),
    lugar_nacimiento: "QUITO", nacionalidad: "ECUATORIANA",
    edad: paciente?.edad?.toString() ?? "", condicion_edad: "A",
    grupo_prioritario: "NO", grupo_prioritario_especifique: "",
    autoidentificacion_etnica: "MESTIZA", nacionalidad_etnica: "N/A", pueblos: "N/A", nivel_educacion: "BACHILLER",
    estado_nivel_educacion: "COMPLETO", tipo_empresa_trabajo: "", ocupacion_profesion: "", seguro_salud: "NING",
    provincia: "PICHINCHA", canton: "QUITO", parroquia: "", barrio_sector: "", calle_principal: "", calle_secundaria: "", referencia_domicilio: "N/R",
    nombre_contacto: "", parentesco_contacto: "", direccion_contacto: "IDEM", telefono_contacto: "",
    forma_llegada: "AMBULATORIO", fuente_informacion: "DIRECTA", institucion_entrega: "", telefono_institucion: "",
    fecha_inicio_atencion: hoy, hora_inicio_atencion: hora, condicion_llegada: "", motivo_atencion: "CIRUGIA PROGRAMADA",
    ...
    reaccion_pupila_der: "POSITIVA", reaccion_pupila_izq: "POSITIVA", llenado_capilar: "<2 SEG",
    ...
    tratamientos: [
      { medicamento: "", via: "", dosis: "", posologia: "", dias: "", descripcion: "INGRESO A PISO" },
      { medicamento: "", via: "", dosis: "", posologia: "", dias: "", descripcion: "CONTROL DE SIGNOS VITALES" },
      { medicamento: "", via: "", dosis: "", posologia: "", dias: "", descripcion: "CONSENTIMIENTOS INFORMADOS" },
      { medicamento: "", via: "", dosis: "", posologia: "", dias: "", descripcion: "PASE A QUIROFANO SEGÚN PROGRAMACION" },
      { medicamento: "", via: "", dosis: "", posologia: "", dias: "", descripcion: "" }
    ],
    egreso_condicion: ["vivo", "estable", "hospitalizacion"], egreso_establecimiento: "", observaciones_egreso: "", dias_reposo: "",
