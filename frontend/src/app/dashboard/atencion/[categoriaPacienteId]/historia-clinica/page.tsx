...
export default function HistoriaClinicaPage() {
  ...
  useEffect(() => {
    async function load() {
      const userEmail = getSessionCookie('user_email'); setIsReadOnly(userEmail === 'administracion@hospitalpanamericano.com.ec' || userEmail === 'laboratorio@hospitalpanamericano.com.ec' || userEmail === 'enfermeria@hospitalpanamericano.com.ec');
      try {
