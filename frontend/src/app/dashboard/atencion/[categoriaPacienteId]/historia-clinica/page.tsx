...
export default function HistoriaClinicaPage() {
  ...
  useEffect(() => {
    async function load() {
      const userEmail = getSessionCookie('user_email'); setIsReadOnly(userEmail === 'administracion.nhpanamericano@gmail.com' || userEmail === 'laboratorio@hospitalpanamericano.com.ec' || userEmail === 'enfermeria.nhpanamericano@gmail.com');
      try {
